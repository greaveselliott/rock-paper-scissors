        ...
        <div className="o-hand-signal-selection">
            {
                hand_signals && hand_signals.map((symbol) => {
                    return (
                        <HandSignal 
                            className="o-hand-signal-selection__signal"
                            key={symbol} 
...
const get_modifier = (this_symbol, selected_symbol, is_contestant_player, is_revealing, has_won) => {
    let modifier = "";
        ...
        modifier += (selected_symbol && this_symbol === selected_symbol && has_won === true) ? "--has-won" : "";
        modifier += (selected_symbol && this_symbol === selected_symbol && has_won === false) ? "--has-lost" : "";
